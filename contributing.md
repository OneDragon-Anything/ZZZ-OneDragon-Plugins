...
> 本文档指引如何创建新应用并接入插件系统。架构细节请参考 [application_plugin_system.md](https://github.com/OneDragon-Anything/ZenlessZoneZero-OneDragon/blob/main/docs/develop/one_dragon/modules/application_plugin_system.md)。
